    ...
    try:
        ...
        if(previous_question_type == question_type):
            ...
            if question_type == "project":
                ...
                prompt = f"Your task is to role-play as a developer interviewer and ask a project-related interview question in Korean, within the limit of 200 characters. The question should be based on the {', '.join(repo_names)}:{', '.join(repo_infos)} and {resume_contents}, and should be relevant to the {position}. The question should be unique and not repeat previous questions. You can also create tail questions that deepen and apply previous answer: {previous_answer.content}. The tail questions should be unique and not repeat previous questions. They should explore different aspects of the candidate's experience, skills, and understanding of the project. Questions should be direct and natural, starting the sentence with references to the candidate's repository and resume. It should sound like a real person is asking the question but refrain from including greetings or personal sentiments.. do not say anything outside of the question and use the word '지원자분' instead of name. Do not include a separate reference section at the end of the question. do not tell me your emotion, greetings, intention"
                ...
                prompt = f"Your task is to role-play as a company's CS expert and interviewer. Ask a natural and flowing question in Korean, within the limit of 200 characters. The question should be based on the {', '.join(repo_names)}:{', '.join(repo_infos)}, {resume_contents}, and {position}, and should be related to computer science topics such as Programming Languages,Data Structures and Algorithms,Operating Systems,Networks,Databases,System Design,Software Engineering,Specific Technology Stacks. The question should sound like a real person is asking but don't say hello. You can also create tail questions that deepen and apply previous answer: {previous_answer.content}. The question should propose a specific problem or situation that tests the candidate's problem-solving skills and understanding of the topic. Questions should be direct and natural, starting the sentence with references to the candidate's repository and resume and refrain from including greetings or personal sentiments.. do not say anything outside of the question and use the word '지원자분' instead of name. Do not include a separate reference section at the end of the question. do not tell me your emotion, greetings, intention"
            else:
                #인성질문
                ...
                prompt = f"You're participating as both the company's HR representative and the interviewer. Your task is to ask one interview question of person's character, humanity type in Korean within the limit of 200 characters. The question should be based on the {', '.join(repo_names)}:{', '.join(repo_infos)}and {resume_contents}, and should be relevant to the {position}. Your question should propose a specific and challenging situation that tests the candidate's teamwork skills, values, and character, and should not repeat any previous questions. The question should flow naturally from the candidate's previous answer: {previous_answer.content}. Questions should be direct and natural, starting the sentence with references to the candidate's repository and resume. It should sound like a real person is asking the question but refrain from including greetings or personal sentiments.. do not say anything outside of the question and use the word '지원자분' instead of name. tions. Do not include a separate reference section at the end of the question. do not tell me your emotion, greetings, intention"
            ...
            if question_type == "project":
                ...
                prompt = f"Your task is to role-play as a developer interviewer and ask a project-related interview question in Korean, within the limit of 200 characters. The question should be based on the {', '.join(repo_names)}:{', '.join(repo_infos)} and {resume_contents}, and should be relevant to the {position}. Questions should be direct and natural, starting the sentence with references to the candidate's repository and resume. It should sound like a real person is asking the question but refrain from including greetings or personal sentiments.. do not say anything outside of the question and use the word '지원자분' instead of name. Do not include a separate reference section at the end of the question. do not tell me your emotion, greetings, intention"
                ...
                prompt = f"Your task is to role-play as a company's CS expert and interviewer. Ask a natural and flowing question in Korean, within the limit of 200 characters. The question should be based on the {', '.join(repo_names)}:{', '.join(repo_infos)}, {resume_contents}, and {position}, and should be related to computer science topics such as Programming Languages,Data Structures and Algorithms,Operating Systems,Networks,Databases,System Design,Software Engineering,Specific Technology Stacks. Questions should be direct and natural, starting the sentence with references to the candidate's repository and resume. The question should sound like a real person is asking but refrain from including greetings or personal sentiments. do not say anything outside of the question and use the word '지원자분' instead of name. Do not include a separate reference section at the end of the question. do not tell me your emotion, greetings, intention"
            else:
                # 인성질문
