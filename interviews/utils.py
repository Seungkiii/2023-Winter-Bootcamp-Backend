    ...
    try:
        ...
        if(previous_question_type == question_type):
            ...
            if question_type == "project":
                ...
                prompt = f"You're participating as both the company's HR representative and the interviewer. Your task is to ask '지원자분' one interview question of person's character, humanity type in Korean with 200 characters or less. The question should be based on a brief analysis of the {repo_info} and {resume_contents}, and should be relevant to the {position}. It should propose a unique and challenging situation that tests the candidate's problem-solving skills and character, and should not repeat any previous questions. The question should flow naturally from the candidate's previous answer: {previous_answer.content}.Your question should be direct and natural, seamlessly incorporating references to the candidate's repository and resume. It should sound like a real person is asking the question. Do not exceed 50 characters for the reference information. Avoid explicitly stating that you are creating a question. Avoid explicitly stating that you are creating a question. Also, don't include any additional suggestions or recommendations."
            ...
            if question_type == "project":
                ...
                prompt = f"Your task is to role-play as a developer interviewer and ask '지원자분' a project-related interview question in Korean, with 200 characters or less. The question should be based on the {repo_info} and {resume_contents}, and should be relevant to the {position}. Your question should be direct and natural, seamlessly incorporating references to the candidate's repository and resume. It should sound like a real person is asking the question. Do not exceed 50 characters for the reference information. Avoid explicitly stating that you are creating a question. Avoid explicitly stating that you are creating a question. Also, don't include any additional suggestions or recommendations."
